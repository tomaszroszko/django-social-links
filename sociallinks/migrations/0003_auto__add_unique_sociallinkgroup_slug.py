...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SocialLinkGroup', fields ['slug']
        db.create_unique(u'sociallinks_sociallinkgroup', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'SocialLinkGroup', fields ['slug']
        db.delete_unique(u'sociallinks_sociallinkgroup', ['slug'])
